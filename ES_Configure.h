...
// #define POSTFUNCTION_FOR_KEYBOARD_INPUT PostSimpleService
...
#define EVENT_CHECK_LIST  SimpleEventChecker
...
#define TIMER0_RESP_FUNC PostSimpleService
...
// CUSTOM ADDITION: changed to 0 from 1
